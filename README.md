...
A collection of low level system programs exploring Linux OS internals, including program loading, process execution, scheduling, and multithreading.

This repository brings together multiple system level projects developed to understand how Linux interacts with processes and hardware beyond standard library abstractions.
...
Each project focuses on a different aspect of **program execution and OS design** on x86-64 systems.
